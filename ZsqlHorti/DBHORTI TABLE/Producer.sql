...
/****** OBJECT:  TABLE [DBO].[PRODUCER]    SCRIPT DATE: 25/09/2019 19:52:16 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [DBO].[PRODUCER]  WITH CHECK ADD  CONSTRAINT [C_PRODUCER_DS_EMAIL] CHECK  ([DS_EMAIL] LIKE '%@%')
GO
