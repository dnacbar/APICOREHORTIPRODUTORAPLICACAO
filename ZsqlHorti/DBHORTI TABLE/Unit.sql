...
ALTER TABLE [DBO].[UNIT] ADD  CONSTRAINT [C_UNIT_ACTIVE]  DEFAULT ((1)) FOR [BO_ACTIVE]
GO

ALTER TABLE [DBO].[UNIT] ADD  CONSTRAINT [C_UNIT_DT_CREATION]  DEFAULT (GETDATE()) FOR [DT_CREATION]
GO
