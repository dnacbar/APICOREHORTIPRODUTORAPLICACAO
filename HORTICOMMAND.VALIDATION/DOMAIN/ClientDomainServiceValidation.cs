...
{
    public sealed class CreateClientDomainServiceValidation : AbstractValidator<IClient>
    {
    ...
    public sealed class UpdateClientDomainServiceValidation : AbstractValidator<IClient>
    {
