...
namespace APPCOREHORTIQUERY.CONVERTER
{
    ...
    {
        public static HashSet<DistrictResult> ToHashSetDistrictResult(this IEnumerable<IDistrict> listDistrict)
        {
        ...
        public static DistrictResult ToDistrictResult(this IDistrict district)
        {
