...
namespace APPCOREHORTIQUERY.CONVERTER
{
    ...
    {
        public static HashSet<ProducerResult> ToHashSetProducerResult(this IEnumerable<IProducer> lstProducer)
        {
        ...
        public static ProducerResult ToProducerResult(this IProducer producer)
        {
